...
*/
    ...
    double * likelihood(double *X, double *y, double *D, double *d, int *nnIndx, int *nnIndxLU, int *CIndx, int n, int p, int m, double *theta, int covModel, int j, int nThreads, double fix_nugget){
        ...
        log_likelihood = Q(B, F, tmp_n, tmp_n, n, nnIndx, nnIndxLU); //+ logDet;
        
        static double out[2];
        out[0] = log_likelihood;
        out[1] = logDet;
...
*/
    ...
    SEXP BRISC2_bootstrapcpp(SEXP X_r, SEXP B_r, SEXP F_r, SEXP Xbeta_r, SEXP norm_residual_boot_r, SEXP D_r, SEXP d_r, SEXP nnIndx_r, SEXP nnIndxLU_r, SEXP CIndx_r, SEXP n_r, SEXP p_r, SEXP m_r, SEXP theta_r, SEXP covModel_r, SEXP j_r, SEXP nThreads_r, SEXP eps_r, SEXP fix_nugget_r){
    ...
    SEXP BRISC2_estimatecpp(SEXP y_r, SEXP X_r, SEXP p_r, SEXP n_r, SEXP m_r, SEXP coords_r, SEXP covModel_r, SEXP alphaSqStarting_r, SEXP sigmaSqStarting_r, SEXP phiStarting_r, SEXP nuStarting_r,
        ...
        if(verbose){
            ...
            Rprintf("----------------------------------------\n");
            Rprintf("BRISC2 model fit with %i observations.\n\n", n_nngp);
        ...
        SEXP llk_r1; PROTECT(llk_r1 = allocVector(REALSXP, 1)); nProtect++; double *fx1 = REAL(llk_r1);
...
/*
        *fx1=likelihood_lbfgs_non_matern(x[i], x[i+1], X_nngp, y_nngp, D_nngp, d_nngp, nnIndx_nngp, nnIndxLU_nngp, CIndx_nngp, n_nngp, p_nngp, m_nngp, covModel_nngp,j_nngp,           nThreads_nngp,fix_nugget_nngp);
        
        
        SEXP result_r1, resultName_r1;
        int nResultListObjs1 = 1;



        PROTECT(result_r1 = allocVector(VECSXP, nResultListObjs1)); nProtect++;
        PROTECT(resultName_r1 = allocVector(VECSXP, nResultListObjs1)); nProtect++;

        SET_VECTOR_ELT(result_r1, 0, llk_r1);
        SET_VECTOR_ELT(resultName_r1, 0, mkChar("log-likelihood"));
        return(result_r1);
 ...
 */       
        double *w = likelihood_lbfgs_non_matern(x[0], x[1], X_nngp, y_nngp, D_nngp, d_nngp, nnIndx_nngp, nnIndxLU_nngp, CIndx_nngp, n_nngp, p_nngp, m_nngp, covModel_nngp,j_nngp,           nThreads_nngp,fix_nugget_nngp);
        double sig2 = REAL(sigmaSqStarting_r)[0];
        double a = w[0]/sig2;
        double b = w[1]+n_nngp*log(sig2);
  
        llk_nngp[0] = a+b;
        
        //llk_nngp[0] = processed_output(X_nngp, y_nngp, D_nngp, d_nngp, nnIndx_nngp, nnIndxLU_nngp, CIndx_nngp, n_nngp, p_nngp, m_nngp, theta_nngp, covModel_nngp, j_nngp, nThreads_nngp, llk, B_nngp, F_nngp, beta_nngp, Xbeta_nngp, norm_residual_nngp, theta_fp_nngp, fix_nugget_nngp);
...
*/
        SET_VECTOR_ELT(result_r, 0, llk_r);
        SET_VECTOR_ELT(resultName_r, 0, mkChar("log_likelihood"));
...
*/
    ...
    SEXP BRISC2_correlationcpp(SEXP n_r, SEXP m_r, SEXP coords_r, SEXP covModel_r, SEXP alphaSqStarting_r, SEXP phiStarting_r, SEXP nuStarting_r,
        ...
        if(verbose){
            ...
            Rprintf("\tModel description\n");
            Rprintf("----------------------------------------\n");
            Rprintf("BRISC2 simulation with %i locations.\n\n", n);
            Rprintf("Using the %s spatial correlation model.\n\n", corName.c_str());
            Rprintf("Using %i nearest neighbors.\n\n", m);
#ifdef _OPENMP
            Rprintf("\nSource compiled with OpenMP support and model fit using %i thread(s).\n", nThreads);
    ...
    SEXP BRISC2_decorrelationcpp(SEXP n_r, SEXP m_r, SEXP coords_r, SEXP covModel_r, SEXP alphaSqStarting_r, SEXP phiStarting_r, SEXP nuStarting_r,
                                SEXP sType_r, SEXP nThreads_r, SEXP verbose_r, SEXP sim_r, SEXP sim_number_r, SEXP fix_nugget_r){
    ...
    SEXP BRISC2_neighborcpp(SEXP n_r, SEXP m_r, SEXP coords_r,
    ...
    SEXP BRISC2_estimateneighborcpp(SEXP y_r, SEXP X_r, SEXP p_r, SEXP n_r, SEXP m_r, SEXP coords_r, SEXP covModel_r, SEXP alphaSqStarting_r, SEXP phiStarting_r, SEXP nuStarting_r,
                           SEXP sType_r, SEXP nThreads_r, SEXP verbose_r, SEXP eps_r, SEXP fix_nugget_r,

BRISC2_simulation <- function(coords, sim_number = 1, seeds =  NULL, sigma.sq = 1, tau.sq = 0, phi = 1, nu = 1.5, n.neighbors = NULL, n_omp = 1,
  ...
  result_list <- BRISC2_correlation(coords, sim, sigma.sq, tau.sq, phi, nu, n.neighbors, n_omp, cov.model, search.type, stabilization, verbose, tol)
  return(result_list)
}
